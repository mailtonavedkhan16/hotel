	  ...
	  <div class="footer-copyright py-3 text-white bg-slate-900">
	    <div class="flex flex-wrap items-center max-w-[960px] mx-auto px-3 justify-between">
	      <span class="my-3 mx-5 leading-normal">
	        ...
	        <a class="text-cyan-400" href="#" target="_blank">Javed</a> | Design inspired by Javed Alam
	...
	<!-- Footer Area End -->
<?php /**PATH /home/vagrant/code/hotel/resources/views/home/partials/footer.blade.php ENDPATH**/ ?>